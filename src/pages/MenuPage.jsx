...
const MENU_ZONES = [
  { key: 'abjad',   path: '/abjad',   top: 53.0, left: 9.2,  width: 20.0, height: 21.5, label: 'Huruf Abjad' },
  ...
  { key: 'game',    path: '/game',    top: 68.0, left: 62.7, width: 19.8, height: 21.5, label: 'Game Time'   },
];
